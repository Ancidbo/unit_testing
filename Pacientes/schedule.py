...
class ShowStudies(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        driver = self.driver
                ...
                #---------------------------revisar aun no funciona para agendar citas en sucursal------------------
    #unit tests  
    def test_schedule_branch(self):
        ...
        #print ("Iteracion " , x)
            ...
            #Login
                ...
                # #Schedule studie branch
                driver.find_element_by_xpath('/html/body/app-root/div/app-menu-carrito/html/body/div/div/div/div/div[1]/div[1]/button').click()
