...
#unit tests
#Cases of test
class NewMedicalHistory(unittest.TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def test_new_medical_history(self):
        driver = self.driver
        ...
        #print ("Iteracion " , x)
            ...
            #Login
                ...
                driver.find_element_by_css_selector('body > ngb-modal-window > div > div > div.modal-body > ul > li:nth-child(2) > a').click()
                time.sleep(1)
                
                # Button new Medical History
                driver.find_element_by_xpath('//*[@id="t-exp-hist"]/div/button[2]').click()
...
if __name__ == "__main__":
    unittest.main(verbosity = 2, testRunner = HTMLTestRunner(output= 'reportes',report_name= 'Nueva Historia clinica')) 