...
#unit tests
#Cases of test
class UpdateQuery(unittest.TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def test_new_update_query(self):
        driver = self.driver
        ...
        #print ("Iteracion " , x)
            ...
            #Login
                ...
                # Button new query
                driver.find_element_by_xpath('/html/body/ngb-modal-window[2]/div/div/div[2]/div[3]/button[2]').click()

            # New Query

                # Evolution note
                evolution_note = driver.find_element_by_xpath('/html/body/ngb-modal-window[2]/div/div/div[2]/div/div[1]/div/div[2]/div[1]/textarea')
                evolution_note.clear()
                evolution_note.send_keys(nota_evolucion)
...
if __name__ == "__main__":
    unittest.main(verbosity = 2, testRunner = HTMLTestRunner(output= 'reportes',report_name= 'Actualizar consulta')) 